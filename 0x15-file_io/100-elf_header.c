/*
 * TAdanced Task No.4 : 100-elf_header.c
 * Done By: Atiemo Samuel
 */
 ...
 * @e_ident: A pointer to an array containing ELF magic numbers address.
 ...
 * @e_ident: A pointer to an array containing the ELF magic numbers address
 ...
 * @e_ident: A pointer to an array containing the ELF class address
 */
 ...
 * @e_ident: A pointer to an array containing the ELF version address
 */
 ...
 * @e_ident: A pointer to an array containing the ELF ABI version address
 */
